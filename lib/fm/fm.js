...
/**
 * @typedef {number|string|boolean|Array|Object|Date|RegExp|null|fm.Entity}
 */
fm.AtomValue;
 ...
 * @type {fm.Scope}
 */
fm.__scopesRoot = null;


/**
 * @type {fm.Scope}
 */
fm.__currentScope = null;
 ...
 * @param {!fm.Args} args
 */
fm.createScope = function(args) {
  if (fm.__scopesRoot === null) {
    fm.__scopesRoot = new fm.Scope(args);
    fm.__currentScope = fm.__scopesRoot;
  } else {
    fm.__currentScope.addChild(new fm.Scope(args, fm.__currentScope));
  }
};
 ...
 *
 */
fm.removeCurrentScope = function() {
  if (fm.__currentScope !== null) {
    fm.__currentScope.getParent().removeChild(fm.__currentScope);
    fm.__currentScope = fm.__currentScope.getParent();
  }
};
 ...
 * @param {string} name
 */
fm.String = function(name) {
  this.__currentScope.populateSymbol(name, fm.Type.STRING);
};
